...
function AppleCard({
  ...
  return (
    <div
      className={`group relative flex flex-col overflow-hidden rounded-4xl bg-white shadow-xl transition-all duration-1000 ${className}`}
      style={{
        opacity: visible ? 1 : 0,
...
export default function Sistem() {
  ...
  return (
    <section ref={sectionRef} id="sistema" className="w-full bg-background py-20 lg:py-40 font-sans">
