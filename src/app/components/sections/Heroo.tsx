        ...
        <div className="flex flex-col items-center">
          ...
          <div className="max-w-4xl space-y-10 flex flex-col items-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center w-full sm:w-auto gap-3">
              ...
              <a
                href="#contacto"
                className="group h-14 w-full sm:w-52 flex items-center justify-center gap-2 rounded-xl bg-[#0B0D12] text-[15px] font-bold text-white transition-all hover:opacity-90 active:scale-[0.98] shadow-lg shadow-[#0B0D12]/50 hover:shadow-2xl hover:shadow-[#0B0D12]/90"
              >
                Empezar
              ...
              <a
                href="#Explorar"
                className="group h-14 w-full sm:w-52 flex items-center justify-center gap-2 rounded-xl border border-[#5E6472]/0 bg-[#F6F8FB] sm:bg-transparent text-[15px] font-medium text-[#5E6472] transition-all hover:bg-[#0B0D12]/5 active:scale-[0.98] shadow-lg shadow-[#0B0D12]/20 hover:shadow-2xl hover:shadow-[#0B0D12]/90"
              >
                Explorar más
